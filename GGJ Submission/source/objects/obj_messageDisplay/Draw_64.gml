...
var str = "Factories Complete: " +string(global.housesCompleted) + "\nFactories in Progress: " + string(global.housesInProgress) + "\nTurnips Remaining: " + string(global.num_turnips);
var string_wid = string_width(str);
var string_heit = string_height(str);

var draw_x_loc = display_get_gui_width()  - string_wid * .55;
